from PIL import ImageGrab, Image, ImageOps, ImageDraw, ImageFilter
...
def add_glow_effect(img, border_size, solid_color, fade_color):
    ...
    for i in range(border_size):
        ...
        color = (
            int(solid_color[0] * (1 - i / border_size) + fade_color[0] * (i / border_size)),
            int(solid_color[1] * (1 - i / border_size) + fade_color[1] * (i / border_size)),
            int(solid_color[2] * (1 - i / border_size) + fade_color[2] * (i / border_size)),
            alpha
        )
...
def handle_screenshot():
    screenshot = capture_screenshot(SCREENSHOT_AREA)
    # Adjust solid_color and fade_color for your desired glow effect
    solid_color = (0, 191, 255)  # Solid color for the part of the glow closest to the photo
